							...
							<div className="androiddev">
								<center>
									...
									<div className="showData">
										<br />
										<p>
											Managing and data <br /> mining the users data<br /> &nbsp;on Wallpo Web and
											&nbsp;&nbsp;<br /> app
										</p>
										<br />
										<br />
							...
							<div className="androiddev">
								<center>
									...
									<div className="showData">
										<br />
										<p>
											Managing share <br />hosting and more than <br />30K+ users data<br /> and
											User experience<br /> &nbsp;on only ToofanKhabre <br /> Web.
										</p>
										<br />
										&nbsp;&nbsp;
									</div>
							...
							<div className="androiddev">
								<center>
									...
									<div className="showData">
										<br />
										<p>
											Setup mail server with<br />zoho for better<br /> mail delivery and <br />{' '}
											experience
										</p>
										<br />
										<br />
